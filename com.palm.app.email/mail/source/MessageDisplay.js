...
enyo.kind({
    ...
    components: [
        ...
        {name: "mailHeaderUnit", style: "border: 1px solid green;", components: [
                            ...
                            {kind: "VFlexBox", flex: 1, pack: "bottom", components: [
                                {kind: "HFlexBox", flex: 1, pack: "bottom", components: [
                                    {flex: 1, showing: true, components: [
                                        ...
                                        {name: "from_addr", className: "mail-body-from-addr", content: "&nbsp;", onclick: "showFromContactDetails", flex: 1}, // this is the sender name
                                        {kind: "VFlexBox", flex: 1, style: "height: 25px;", components: [
                                                ...
                                                // This is the to: line
                                                {name: "to", kind: "", allowHtml: true, className: "mail-body-recipients", onclick: "toggleRecipients"},
